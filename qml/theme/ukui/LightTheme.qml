...
QtObject {
    ...
    // 字符按键颜色
    property color charKeyNormalColor: getColorFromGradient(Platform.GlobalTheme.kSelectAlphaWhite)
    property color charKeyPressedColor: getColorFromGradient(Platform.GlobalTheme.kComponentSelectedAlphaClick)
    property color charKeyHoverColor: getColorFromGradient(Platform.GlobalTheme.kComponentSelectedAlphaHover)
    property color charKeyDropShadowColor: Qt.rgba(115 / 255, 115 / 255, 115 / 255, 0.8) // 固定值
    // 动作按键颜色
    property color actionKeyNormalColor: getColorFromGradientByTransparency(Platform.GlobalTheme.kComponentAlphaNormal)
    ...
    // 开关按键颜色
    property color switchKeyNormalColor: getColorFromGradientByTransparency(Platform.GlobalTheme.kComponentAlphaNormal)
    ...
    property color switchKeyOpenDropShadowColor: Qt.rgba(115 / 255, 115 / 255, 115 / 255, 0.8)
    ...
    // 拖拽条
    property color dragBarIndicatorColor: getColorFromGradient(Platform.GlobalTheme.kFontPrimary)
    // 关闭按钮
